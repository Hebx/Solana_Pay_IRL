...
export default function CouponBook() {
	...
	try {
		...
		if (e instanceof TokenAccountNotFoundError) {
			// OK, the API will create one when they make a payment
			console.log(`User ${publicKey} doesnt have a coupon yet`)
			setCouponBalance(0)
		} else {
...
return (
	<>
	 <div className="flex flex-col bg-gray-900 text-white rounded-md p-1 items-center">
        <p>Collect 5 packs to receive a 50% discount on your next purchase!</p>
